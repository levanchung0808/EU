...
public class SelectCharacter : MonoBehaviour
{
    ...
    void OnAnimationChanged()
    {
        ...
        Debug.Log("skeletonGraphics length: " + skeletonGraphics.Length);
    ...
    void TestAll()
    {
        ...
        /*for (int classIdx = 0; classIdx < 5; classIdx++)
        {
            ...
            for (int classValue = 2; classValue <= 6; classValue += 2)
            {
        ...
        int total = 0;
        Debug.Log("BOODIES COUNT: " + bodies.Count);
    ...
    void Test6()
    {
        ...
        //body-mystic-normal
        for (int classIdx = 0; classIdx < 1; classIdx++)
        {
            var characterClass = (CharacterClass)classIdx;
            string key = $"{characterClass}-mystic-02";
            bodies.Add((key, (classIdx % 2 == 0) ? "body-mystic-normal" : "body-mystic-fuzzy", classIdx, 2));
            Debug.Log("key " + key);
            Debug.Log("body " + ((classIdx % 2 == 0) ? "body-mystic-normal" : "body-mystic-fuzzy"));
            Debug.Log("classIdx " + classIdx);
            Debug.Log("classValue " + 2);
        }
        ...
        foreach (var (key, body, classIdx, classValue) in bodies)
        {
            ...
            int row = total / 1;
            int col = total % 1;
            go.transform.localPosition = new Vector3(row * 1.85f, col * 1.5f) - new Vector3(5.6f, 0.1f, 0);
